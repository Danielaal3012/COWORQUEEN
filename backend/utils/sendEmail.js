...
const htmlRegistro = "backend/utils/emails/verificationEmail.html";  //correo de verificacion 
...
const htmlRegistro = "backend/utils/emails/validationEmail.html";  //correo de validación
...
const htmlRegistro = "backend/utils/emails/forgotPassword.html";  //correo de recuperacion contraseña 
const htmltemplate = fs.readFileSync(htmlRegistro, 'utf8');
const template = handlebars.compile(htmltemplate);
...
const htmlRegistro = "backend/utils/emails/changePassword.html";  //correo de recuperacion contraseña 
const htmlContent = fs.readFileSync(htmlRegistro, 'utf8');
...
const htmlRegistro = "backend/utils/emails/createdReservation.html";  //correo de recuperacion contraseña 
const htmltemplate = fs.readFileSync(htmlRegistro, 'utf8');
const template = handlebars.compile(htmltemplate);
